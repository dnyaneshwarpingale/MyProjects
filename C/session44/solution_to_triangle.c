...
int main(void)
{
    ...
    double c;   /* For storing length of side AB */

    double A;   /* For storing measure of angle A in radians */
    double B;   /* For storing measure of angle B in radians */
    double C;   /* For storing measure of angle C in radians */

    printf("Enter x coordinate of vertex A:"); 
    scanf("%lf", &x1); 

    printf("Enter y coordinate of vertex A:"); 
    scanf("%lf", &y1); 

    printf("Enter x coordinate of vertex B:"); 
    scanf("%lf", &x2); 

    printf("Enter y coordinate of vertex B:"); 
    scanf("%lf", &y2); 

    printf("Enter x coordinate of vertex C:"); 
    scanf("%lf", &x3); 
    ...
    {
        puts("Sum of any two sides of a triangle is greather than its third side"); 
        puts("This condition is not satisified"); 
        puts("Therefore, A, B, and C are collinear points that cant form a triangle");
        puts("exiting..."); 
        exit(-1); 
    }
