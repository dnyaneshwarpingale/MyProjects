...
//code
    ...
    case WM_CREATE:
        ...
        cakex = rect.right - CIRCLE_DIAMETER-100; 
    ...
    case WM_PAINT:
       ...
       z = (rect.right - rect.left) - CIRCLE_DIAMETER;
        ...
        if (hBrush)
        {
            ...
            //cakex = rect.right - CIRCLE_DIAMETER;
            //make the painter color the client area rectangle with selected brush
            Rectangle(hdc, cakex, cakey, cakex + CIRCLE_DIAMETER, cakey + CIRCLE_DIAMETER);
            ...
            hBrush = CreateSolidBrush(RGB(123, 63, 0));
            ...
            //make the painter color the client area rectangle with selected brush
            Rectangle(hdc, cakex-20, cakey+20, cakex + CIRCLE_DIAMETER +20, cakey + CIRCLE_DIAMETER +20);
    ...
    case WM_TIMER:
        ...
        if (cake){
            ...
            cakex=cakex+3;
            if (cakex + CIRCLE_DIAMETER >= rect.right-100) {
                cakex = rect.right - CIRCLE_DIAMETER-100;
                cake = TRUE; 
            }
        }
