...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
       ...
       //Proving Identity property of queryinterface
       hr = pISum->QueryInterface(IID_IUnknown, (void**)&pIUnknownFromISum);

       if (FAILED(hr)) 
       {
           MessageBox(NULL, TEXT("cocreate instance failed to obtain IUnknown from ISUM"), TEXT("COM ERROR"), MB_OK | MB_ICONERROR);
       ...
       if (FAILED(hr))
       {
           MessageBox(NULL, TEXT("cocreate instance failed to obtain IUnknown from Isubtract"), TEXT("COM ERROR"), MB_OK | MB_ICONERROR); 
       ...
       {
           MessageBox(NULL, TEXT("Hence Identity Proved"), TEXT("Property"), MB_OK );
           DestroyWindow(hwnd); 

       }
       else {
           MessageBox(NULL, TEXT("Not same"), TEXT("Property"), MB_OK | MB_ICONERROR);
           DestroyWindow(hwnd); 
       }
