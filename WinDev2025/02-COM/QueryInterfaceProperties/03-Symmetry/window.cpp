...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
       ...
       //Proving Symmetric  property of queryinterface
       ...
       if (pISum = pISumAgain) {
           MessageBox(NULL, TEXT("Symmetry  property proved"), TEXT("Proerty3"), MB_OK );
       }
       else {
           MessageBox(NULL, TEXT("Symmetry  not property proved"), TEXT("Proerty3"), MB_OK);
