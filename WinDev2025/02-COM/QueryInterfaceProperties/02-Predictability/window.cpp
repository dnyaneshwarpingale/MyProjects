...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
       ...
       //Proving Predictability property of queryinterface
       Sleep(1000);
       hr = pISum->QueryInterface(IID_ISubtract, (void**)&pISubtractAgain); 
       if (FAILED(hr)) 
       {
           MessageBox(NULL, TEXT("cocreate instance failed to obtain pISubtractAgain from PIsum"), TEXT("COM ERROR"), MB_OK | MB_ICONERROR); 
       ...
       {
           MessageBox(NULL, TEXT("Predictability Proved"), TEXT("Property2"), MB_OK );
           DestroyWindow(hwnd);
       }
       else {
           MessageBox(NULL, TEXT("Predictability not Proved"), TEXT("Property2"), MB_OK | MB_ICONERROR);
           DestroyWindow(hwnd);
       }
