...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
       ...
       //Proving Reflexivity  property of queryinterface
       hr = pISum->QueryInterface(IID_ISum, (void**)&pISumAgain);

       if (FAILED(hr))
       {
           MessageBox(NULL, TEXT("cocreate instance failed to obtain ISumAgain from isubtract"), TEXT("COM ERROR"), MB_OK | MB_ICONERROR);
       ...
       if (pISum = pISumAgain) {
           MessageBox(NULL, TEXT("Reflexivity  property proved"), TEXT("Proerty3"), MB_OK );
       }
       else {
           MessageBox(NULL, TEXT("Reflexivity  not property proved"), TEXT("Proerty3"), MB_OK);
