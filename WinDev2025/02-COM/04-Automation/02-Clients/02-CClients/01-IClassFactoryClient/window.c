...
#include "Window.h"
//CHANGE NO: C SYNTAX AUTOMATION.H HEADER FILE
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    {
    case WM_CREATE:
        //CHANGE NO: SINCE THIS IS C CLIENT WE CAN NOT SEND REFERENCE OF CLSID SO WE CAN SEND ADDRESS OF CLSID 
        hr = CoCreateInstance(&CLSID_MyMath, NULL, CLSCTX_INPROC_SERVER, &IID_IMyMath, (void**)&pIMyMath); //CLSCTX_INPROC_SERVER==which type of server 
        ...
        pIMyMath->lpVtbl->SumOfTwoIntegers(pIMyMath, num1, num2, &sum);
        wsprintf(str, TEXT("Sum of %d and %d : %d"),num1,num2, sum); 
        MessageBox(NULL, str, TEXT("Message"), MB_OK); 

        pIMyMath->lpVtbl->SubtractionOfTwoIntegers(pIMyMath,num1, num2, &sub); 
