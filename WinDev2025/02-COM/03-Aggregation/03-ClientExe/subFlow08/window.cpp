...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    {
    case WM_CREATE:
        hr = CoCreateInstance(CLSID_MultiplicationDevision, NULL, CLSCTX_INPROC_SERVER, IID_IMultiplication, (void**)&pIMultiplication); //CLSCTX_INPROC_SERVER==which type of server
        ...
        pIMultiplication->MultiplicationOfTwoIntegers(num1, num2, &sum); 
        wsprintf(str, TEXT("Multiplication of %d and %d : %d"),num1,num2, sum); 
       ...
       pIDevision->DevisionOfTwoIntegers(num1, num2, &sub);
       wsprintf(str, TEXT("Devision of %d and %d : %d"), num1, num2, sub);
       MessageBox(NULL, str, TEXT("Message"), MB_OK); 
